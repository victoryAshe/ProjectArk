...
// Called every frame
void APACharacter::Tick(float DeltaSeconds)
{
...
void APACharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("SetCameraScope"), this, &APACharacter::SetCameraScope);
}

void APACharacter::SetCameraScope(float NewAxisValue)
{
